...
/// END MicroEvents
    ...
    **/
    ...
    function validateSpec(spec){
        return _.reduce(spec, function(fields, s, i){
    ...
    _.extend(Tabler.prototype, {
        ...
        **/
        destroy: function(){
            ...
            this.spec = [];
            _.forEach(this._plugins, function(pluginName){
        ...
        **/
        getField: function(matcher){
            ...
            return _.detect(this.spec, function(spec){
                if(_.all(matcher, function(value, key){
        ...
        **/
        ...
        getSpec: function(data){
            ...
            spec = _.filter(this.spec, function(colSpec){
        ...
        **/
        render: function(){
            ...
            this.fetch(options, _.bind(this.renderTable, this));
        },
        update: function(index, newItem, options){
            ...
            _.forEach(spec, function(spec, index){
                if(spec.disabled){
                    return;
                }
...
///DEBUG*/
        ...
        **/
        renderHead: function(data, spec){
            ...
            if(_.any(spec, function(col){return !!col.name || !!col.headerFormatter;})){
                // Main headings
        ...
        renderHeadRow: function(spec){
            return this.renderHeadTr() + _.map(spec, function(colSpec){
        ...
        **/
        renderBody: function(data, spec){
            var self = this,
                body = _.map(data.items, function(row, i){
        ...
        renderRow: function(row, i, spec){
            ...
            return [this.renderBodyTr(row)].concat(_.map(spec, function(colSpec){
